...
@app.route("/task")
def hello_world():
    h = {"Ocp-Acim-Subscription-Key":sys.argv[1]}
    response = requests.post(url="https://dellsemanticproductlink.cognitiveservices.azure.com/language/analyze-text/jobs?api-version=2022-10-01-preview",headers=h,data=task_json)
